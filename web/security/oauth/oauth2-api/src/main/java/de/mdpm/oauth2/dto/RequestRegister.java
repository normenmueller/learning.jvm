...
public final class RequestRegister {
  ...
  @JsonCreator
  public RequestRegister(String type, String client_name, String client_url, String client_description, String redirect_url) {
  ...
  public boolean equals(@Nullable Object another) {
    if (this == another)
      return true;
    return another instanceof RequestRegister && equalTo((RequestRegister) another);
  }

  private boolean equalTo(RequestRegister another) {
  ...
  public String toString() {
    return MoreObjects.toStringHelper("RequestRegister").add("type", type).add("client_name", client_name).add("client_url", client_url).add("client_description", client_description).add("redirect_url", redirect_url).toString();
  }
}
